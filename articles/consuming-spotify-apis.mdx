...
_**pages/api/spotify/current-listening**_
...
_**pages/api/spotify/recently-played.tsx**_
...
So I've created a new api in _**pages/api/spotify/top.jsx**_, that calls two methods: `getTopArtists()` and `getTopTracks()`. Those methods resolve _Spotify endpoints_ and returns the data.
