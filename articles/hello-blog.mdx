...
This packages allows you load MDX files from anywhere, in this case I'll retrieve the data using `Node.js`.

## ⚙️ The Parser

This module will _fetch_, _resolve_, _sort_ and _compile_ all the MDX files.
...
Finally I prepare the object, composing others elements and properties useful for the frontend such as the **reading-time**, the **permalink**, the **date**, etc.
