...
description: "L'enciclica Rerum Novarum di Papa Leone XIII del 1891 predisse la crisi attuale dell'AI. Scopri i paralleli tra rivoluzione industriale e intelligenza artificiale, e perché la soluzione è ancora la stessa via di mezzo tra estremi opposti."
tags:
...
categories:
  ...
  - Etica digitale
  - Società
keywords: ["Rerum Novarum", "enciclica Leone XIII", "analisi Rerum Novarum", "intelligenza artificiale", "etica dell'AI", "algoritmi", "Big Tech", "società digitale", "filosofia della tecnologia", "rivoluzione industriale", "capitalismo digitale", "feudalesimo digitale", "dataismo", "AGI", "automazione del lavoro", "dignità umana", "regolamentazione tecnologica", "capitalismo della sorveglianza"]
schema:
  type: "Article"
  datePublished: "2025-06-30"
  dateModified: "2025-08-18"
  headline: "Rerum Novarum - 134 anni dopo: Intelligenza Artificiale e Dignità Umana"
  articleSection: "Philosophy & Technology"
  inLanguage: "it-IT"
  mainEntityOfPage: "/blog/rerum-novarum"
  about: ["Rerum Novarum", "Leone XIII", "Intelligenza Artificiale", "Etica Digitale"]
  mentions: ["Papa Leone XIII", "Big Tech", "Algoritmi", "Rivoluzione Industriale"]
---
...
<Image
  ...
  width="1280"
  height="720"
  alt="Leone XIII Rerum Novarum e intelligenza artificiale - paralleli storici"
...
## Indice
1. [Premessa](#premessa)
2. [Si misura in Epochs, un secolo](#si-misura-in-epochs-un-secolo)
3. [La Storia si Ripete](#la-storia-si-ripete)
4. [Il Dio Algoritmo](#il-dio-algoritmo)
5. [La Via di Mezzo](#la-via-di-mezzo)
6. [Riflessione](#riflessione)
...
Sono un semplice [programmatore](https://github.com/mateonunez), nient'altro. Ma tocco ogni giorno con mano questo cambiamento. Ne sono anche un po' artefice (anche se in una piccolissima parte), e ne sarò sicuramente vittima (in una grossa parte). Come ho raccontato in altri [articoli del blog](/blog), la tecnologia sta trasformando radicalmente il nostro modo di lavorare e vivere.
...
### Esempi Concreti di Alternative Digitali
...
Domattina mi sveglierò, aprirò il mio laptop, e inizierò a scrivere altre righe di codice (_o dirò a qualche Agent di supportarmi_). Piccoli frammenti che alimenteranno algoritmi che non controllo direttamente, aiutando aziende a lucrare indirettamente, fornendo dati che alimentano la **ricerca del progresso**. Come sviluppatore che contribuisce a [progetti open source](/open-source), mi interrogo costantemente su queste dinamiche.
