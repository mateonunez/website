...
Each hook accepts a callback function that will be executed before or after the execution of the tests and some options to configure the behavior of the hook.
...
test('should use hooks', async (t) => {
  ...
  t.beforeEach(() => console.log('beforeEach from test'));
  t.after(() => console.log('after from test'));
  t.afterEach(() => console.log('afterEach from test'));
...
describe('should use hooks with describe/it syntax', () => {
  ...
  beforeEach(() => console.log('beforeEach from describe'));
  after(() => console.log('after from describe'));
  afterEach(() => console.log('afterEach from describe'));
