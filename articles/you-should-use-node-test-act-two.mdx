...
I finally decided to finish this article. Obviously while I'm waiting for the plane to come home a bit (🇨🇴). The reason why I couldn't finish it earlier is because I was trying to fix some performance issues in my personal blog.
...
If you haven't read the [Act One](/blog/you-should-use-node-test-act-one), I recommend you to do it before reading the next article.
