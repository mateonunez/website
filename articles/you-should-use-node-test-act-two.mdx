...
I've been working on a still WIP [PR](https://github.com/mateonunez/website/pull/406), but Next.js and MDX aren't being very cooperative. However, the outcome is fantastic, and you can check it out [here](mateonunezx).
