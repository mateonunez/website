...
import { MN, Menu, Close } from '@/components/legacy/icons';
import cn from 'classnames';
import SocialLinks from '@/components/legacy/common/social-links/social-links';

const ActiveLink = ({ href, children, title }: { href: string; children: ReactNode; title: string }): JSX.Element => {
  const pathname = '/blog';
