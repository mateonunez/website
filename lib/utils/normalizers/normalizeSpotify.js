...
export const normalizeArtists = ({ id, name, popularity, genres, external_urls, images }) => ({
  id,
  name,
  popularity,
  genres: genres?.join(' '),
...
export const normalizeTracks = ({ id, name, artists, album, external_urls, duration_ms }) => ({
  id,
  title: name,
